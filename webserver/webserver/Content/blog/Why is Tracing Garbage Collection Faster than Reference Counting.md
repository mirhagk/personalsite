...
So the basic memory allocation process was born, consisting of 2 functions `allocate` and `free`, which would allocate you memory and free it, as the names suggested. There were several problems though. The first 
